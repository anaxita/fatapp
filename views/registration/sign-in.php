...
<link href="https://fonts.googleapis.com/css?family=Roboto" rel="stylesheet">
  ...
  <nav class="navbar  navbar-dark bg-dark justify-content-center">
    ...
    <form class="form-signin mt-5" id="sign-in-form" name="sign-in-form">
  ...
  <label><input type="checkbox" class="password-checkbox"> Показать пароль</label>      
      ...
      <button type="button" class="mb-2 btn btn-primary btn-lg btn-block" id="sign-in-button">Войти</button>
      <small>Нет аккаунта? <a href="sign-up.php">Зарегистрируйтесь</a></small>
      <p class="alert alert-danger" id="validation" hidden>Text</p>
    </form>
